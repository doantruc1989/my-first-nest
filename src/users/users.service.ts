...
import { ForgottenPassword } from 'src/auth/interface/forgottenpassword.interface';
...
export class UsersService {
    ...
    async sendEmailForgotPassword(email: string): Promise<void> {
        ...
        const GOOGLE_MAILER_REFRESH_TOKEN = '1//04-oYX6EQNJURCgYIARAAGAQSNwF-L9Ir6UbMK7UVxoFpIv5gtGHPLlryhMMlzYYaG34lXT5d1AynzoRdzxzLdtnKLS0z3aDqJYk'
        ...
        let mailOptions = {
            ...
            html: 'Hi! <br><br> If you requested to reset your password<br><br>' +
                `http://${APP_HOST}:${APP_PORT}/auth/email/reset-password/`
        };
